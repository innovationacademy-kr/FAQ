...
* 42 SEOUL은 강남구 개포동의 개포디지털혁신파크에 위치하고 있습니다.
...
* 커리쿨럼은 소프트웨어 산업 환경에 따라 바뀔 수 있습니다.

### 교육의 시작 시점과 총 학습 기간은 어느 정도 인가요?

* 모든 사람이 다르기 때문에 각자 자기 속도에 맞춰 학습할 수 있다고 믿고 있지만, 공공재인 교육기관의 운영 관점에서 정한 바는 다음과 같습니다.
* 교육의 시작은 온라인 테스트를 거쳐 La Piscine 대상자를 1단계 선발하며, La Piscine 과정을 거쳐 최종 선발된 교육생은 2단계인 본 과정에 진입하게 됩니다. 또한 42 SEOUL에서 요구하는 필수 참석 이벤트에 반드시 참석하셔야 합니다.
...
* 제공된 평가등급표를 이용하여 교육생들이 상호 평가하는 방식으로 서로 프로젝트를 평가할 것입니다. 이 방법은 동료간 학습의 중요한 부분으로 서로 다른 역량과 관심을 가진 동료의 평가와 리뷰를 통해 배우게 됩니다.
...
* 네 많습니다. 프랑스 파리에서 에꼴42로 잘 알려진 첫 번째 42 Paris의 성공에 이어 미국 샌프란시스코, 벨기에 브뤼셀, 핀란드 헬싱키, 도쿄 등 세계 각국에서 운영되고 있으며, 2020년까지 전 세계에 약 20개 정도로 확대될 예정입니다.
...
* 42 SEOUL에서 요구하는 학습 시간 이상을 참석하시는 분에게 지원금이 지급됩니다. 단, 취업자(또는 사업자 등록증이 있는 자) 및 중복 수혜가 불가능한 타 정부 사업에 참여하고 계신분은 42 SEOUL 지원에 제한은 없으나, 병행을 권장하지 않으며 지원금 지급 대상자에서 제외됩니다.
...
* 본 과정 중단 후 다시 돌아와 멈춘 시점부터 다시 시작하는 것은 군입대, 질병과 같이 불가피한 상황일 때만 가능하며, 그 외의 특별한 상황이 있다면 내부 운영 위원회를 통해 결정됩니다.
...
* 학습기간 동안 개인 컴퓨터가 필요하지 않습니다. 교육관에는 모든 교육생들의 학습을 지원할 수 있는 충분한 컴퓨터가 준비되고, 24시간 이용 가능하게 개방됩니다.
