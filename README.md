...
* 42 SEOUL은 서울 강남구 개포동의 개포디지털혁신파크에 위치하고 있습니다.
...
* 체크인 미팅은 선착순으로 '등록' 마감되기 때문에, 교육과정 참석을 원하시는 분은 반드시 온라인 테스트 통과 메일을 수신 후 등록을 완료하시기 바랍니다.
...
* 교육의 시작은 온라인 테스트를 거쳐 La Piscine 대상자를 선착순으로 1단계 선발하며, La Piscine 과정을 거쳐 최종 선발된 교육생은 2단계인 본 과정에 진입하게 됩니다. 또한 42 SEOUL에서 요구하는 필수 참석 이벤트에 반드시 참석하셔야 합니다.
...
* C 언어 프로그래밍과 기본적인 프로그래밍 개념을 기반으로 시작하여 스스로 운영체제, 그래픽 및 웹 프로그래밍 등을 학습합니다.
* 이후에 다양한 프로그래밍 언어로 객체지향 프로그래밍, 모바일 프로그래밍, 웹 보안, 리버스 엔지니어링, 커널 프로그래밍, 네트워크 프로그래밍, 인공 지능, 3D 프로그래밍 등의 커리큘럼이 포함되어 있으며, 지속적으로 새로운 영역이 포함될 것입니다.
