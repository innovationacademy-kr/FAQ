...
* 체크인 미팅, La Piscine 일정은 [42 SEOUL 홈페이지](https://42seoul.kr/)에 게시됩니다.
...
* 네 많습니다. 프랑스 파리에서 에꼴42로 잘 알려진 첫 번째 42 Paris의 성공에 이어 미국 샌프란시스코, 벨기에 브뤼셀, 핀란드 헬싱키, 도쿄 등 세계 각국에서 운영되고 있으며, 2020년까지 전 세계에 약 20여개 정도로 확대될 예정입니다.
...
* 프로그램을 진행하는 동안 교육생들은 자신만의 포트폴리오를 만들게됩니다. 과정을 마치면 프로그램을 완료했다는 증거로 인증서를 받게 되며, 중간에 취업을 위한 단계별 수료증도 제공됩니다. 하지만 이런 인증서, 수료증보다는 소프트웨어를 이용한 문제 해결 능력으로 산업에서 평가받게 될 것입니다. 
...
* 2020년 기준으로 월 100만원 수준의 지원금이 지급됩니다.

### 교육관에 기숙사가 있나요?

* 기숙사를 제공할 계획은 없습니다. 다만 24시간 운영을 하는 관계로 교육생들이 휴식을 취할 수 있는 휴게 시설, 샤워 시설이 확보되어 있습니다.

### 원격으로도 공부할 수 있나요?

* 개인용 PC나 노트북을 이용하여 원격으로 프로젝트 작업 수행은 가능하지만 42 SEOUL의 서버로 접근은 불가능합니다. 
* (다만, 2020년 전세계적인 COVID-19 사태로 원격접속을 허용하고 있습니다.)
...
* (다만, 2020년 전세계적인 COVID-19 사태로 정부의 대책에 따라 교육관을 폐쇄하는 경우가 있습니다.)
...
* 본 과정 중단 후 다시 돌아와 멈춘 시점부터 다시 시작하는 것은 군입대, 질병과 같이 불가피한 상황일 때만 가능하며, 그 외의 매우 특별한 상황이 있다면 내부 운영 위원회를 통해 결정됩니다.
* 반대로 42 SEOUL가 교육생의 역량 증진에 도움이 안되는 경우, 42 SEOUL 측에서 다른 커리어를 추구할 수 있도록 그만 두게 할 수도 있습니다.
...
* 교육관 내에서 개인 연구 중에는 자신의 노트북을 사용해도 되지만 반드시 필요한 것은 아니며, 모든 프로젝트, 학습 결과물은 반드시 교육관의 컴퓨터를 이용하여 제출해야합니다.
