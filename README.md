...
* 제출한 에세이의 내용은 평가에 반영되지 않지만, 에세이 제출자만이 교육 선발 대상자가 됩니다. 또한 에세이 작성 미비 또는 신원 불분명한 지원자의 경우 온라인 테스트 통과 여부에 관계없이 교육 선발 대상자에서 제외될수 있습니다.
...
* 최초 5개 공통프로젝트를 필수로 수행한 후, Web, System, Algorithm, 3D Graphic의 4가지 전문 트랙을 선택할 수 있습니다.
