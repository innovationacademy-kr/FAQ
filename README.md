...
* 이노베이션 아카데미는 창의성(Creativity), 비판적 사고(Critical Thinking), 도전정신(Challenge), 융합(Convergence), 공감과 협업(Collaboration)의 5C 역량을 가진 인재 양성을 목표로 합니다. 모든 사람은 자신만의 특별한 영역에 창의성을 가지고 있기 때문에, 다른 4개의 역량을 키워 이미 가지고 있던 창의성으로 세상을 바꿀 수 있는 혁신적 인재를 양성하고자 합니다.
...
* 이노베이션 아카데미는 특정 문제를 해결하는 스킬 혹은 도구를 사용하는 방법을 가르쳐주지 않습니다. 모든 것을 스스로, 동료와 함께 배우고, 주어진 도구들을 이용하여 문제를 해결하면서 역량을 키워나가게 됩니다.
