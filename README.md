...
* 온라인 테스트를 거친 지원자는 본인 확인 및 신청조건 해당 여부를 확인하기 위해 Check-in 기간에 반드시 참석해야 합니다.  
* 온라인 테스트를 통과 후 체크인 미팅 '등록'을 한 지원자에 한해 선착순으로 마감되기 때문에, 참석을 원하시는 분은 반드시 등록을 완료하시기 바랍니다.
* Check-in 기간에 본인 확인이 완료된 지원자는 에세이를 제출해야 합니다. 에세이는 개인 정보, 학력과 경력의 나열, 그리고 소프트웨어를 배우려는 동기와 이전 경험 및 진로 계획 등 1,000자 내외로 작성해야 합니다.
* 제출한 에세이의 내용은 평가에 반영되지 않지만, 에세이 작성 미비 또는 신원 불분명한 지원자의 경우 온라인 테스트 통과 여부에 관계없이 교육 선발 대상자에서 제외될 수 있습니다.
* 본인 확인 및 에세이 제출을 완료한 지원자는 오리엔테이션 및 창의캠프에 참석 후 La Piscine(1개월 집중교육) 과정에 참여하게 됩니다.
* La Piscine 과정을 거쳐 최종 선발된 250여명의 교육생은 약 2년간 본 과정에 참여하게 됩니다. 
