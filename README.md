...
* 2019년 10월 중순이후 선발을 위한 접수 및 전형이 시작되어 약 한달여간 접수가 진행됩니다.
...
* 온라인 테스트는 코딩과 유사한 테스트가 포함되지만, 코딩을 전혀 안해보신 분들도 통과가 가능한 방식으로 진행됩니다.
* 온라인 테스트와 서류 제출을 거쳐 1차 선발된 인원은, 1개월 동안의 집중학습 기간을 거친 뒤, 일부만 2단계로 진입하여 2년간 학습하게 됩니다. 
* 세부적인 선발 절차 및 선발 과정, 교육 일정 안내는 10월 2주차에 공개될 예정입니다.
